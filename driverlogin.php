 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    //          if(password_verify($Password,$row["Password"])){
        ...
        $login=true;
         session_start();
         $_SESSION['login'] = true;
         $_SESSION['driveremail'] = $EmailID;
          $_SESSION['drivername']= $username;
          $_SESSION['driverPhone']= $phnno;
          $_SESSION['driverPassword']= $pass;
          $_SESSION['drivertype']= $type;
...
<?php
if($login){
    echo ' <div class="alert alert-success alert-dismissible fade show" role="alert" style="background-color:white; height: 70px; font-size:30px;text-align:center;padding-top:2px;">
...
?>
    ...
    <div class="box">
        <form action="/CBS/driverlogin.php" method="post">
        <h1>LOGIN</h1>
        <div class="username">
