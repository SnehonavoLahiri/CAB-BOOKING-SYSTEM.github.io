...
//  }
//  else{
  // if($pass == $_SESSION['word']){
    $csql="SELECT * FROM signup WHERE Phone='$Phone'";
    $r=mysqli_query($conn,$csql);
    $n=mysqli_num_rows($r);
    ...
    // if(($Password == $cpassword)){
        ...
        $sql = "UPDATE signup SET Phone='$Phone' WHERE EmailID='$Email'";
...
echo'<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Congratulations!</strong> Your phone number has been RESET Successfully! Click here to go to  <a href="ride_sublogin.php">PROFILE</a>
...
if($exists){
  ...
  <strong>Phone Number Already Exists!!</strong>Please Use another Phone Number...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if($error){
  echo'<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Invalid Current Password!!</strong>  Passwords DO NOT Match...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if($desc){
...
?>
  ...
  <section>
    <h1 style="text-align: center;">Reset Phone Number </h1>
    <form action="/CBS/updatephn.php" method="POST">
      ...
      <!-- <label for="FormControl" class="form-label"><i class="fas fa-key"></i> Current password</label>
        ...
        <label for="FormControl" class="form-label"><i class="fas fa-key"></i> Reset Phone Number</label>
        <input type="tel" class="form-control" maxlength="10" id="FormControl"
          placeholder="Reset Phone Number" name="Phone" required>
