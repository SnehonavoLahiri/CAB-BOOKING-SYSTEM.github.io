...
if($desc){
  ...
  <strong>Invalid Security KEY!!</strong> Security KEY Doesnt Match,Please Enter Correct Security KEY
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
?>
  ...
  <section>
    ...
    <form action="/CBS/forgot.php" method="POST">
      <div class="mb-1" style="width:50% ;margin-left:2%;">
        ...
        <input type="email" class="form-control " id="FormControl" placeholder="xyz@example.com" name="EmailID" required>
